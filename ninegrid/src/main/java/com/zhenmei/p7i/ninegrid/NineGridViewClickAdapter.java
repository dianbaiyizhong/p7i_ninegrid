...
import com.zhenmei.p7i.ninegrid.round.RoundNineGridViewAdapter;
import com.zhenmei.p7i.ninegrid.round.preview.RoundImagePreviewActivity;

import java.io.Serializable;
import java.util.List;

public class NineGridViewClickAdapter extends RoundNineGridViewAdapter {
    ...
    protected void onImageItemClick(Context context, RoundNineGridView nineGridView, int index, List<ImageInfo> imageInfo) {
        ...
        Intent intent = new Intent(context, RoundImagePreviewActivity.class);
        Bundle bundle = new Bundle();
        bundle.putSerializable(RoundImagePreviewActivity.IMAGE_INFO, (Serializable) imageInfo);
        bundle.putInt(RoundImagePreviewActivity.CURRENT_ITEM, index);
