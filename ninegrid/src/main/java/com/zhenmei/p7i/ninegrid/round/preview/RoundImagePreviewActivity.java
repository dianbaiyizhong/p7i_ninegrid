...
public class RoundImagePreviewActivity extends Activity implements ViewTreeObserver.OnPreDrawListener {
    ...
    private RoundImagePreviewAdapter imagePreviewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagePreviewAdapter = new RoundImagePreviewAdapter(this, imageInfo);
