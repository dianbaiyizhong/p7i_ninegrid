...
public class RoundNineGridViewWrapper extends RoundedImageView {
    ...
    public RoundNineGridViewWrapper(Context context) {
        this(context, null);
    }

    public RoundNineGridViewWrapper(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RoundNineGridViewWrapper(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (moreNum > 0) {
            float[] radiusArray = {0f, 0f, cornerRadius, cornerRadius, cornerRadius, cornerRadius, 0f, 0f};
