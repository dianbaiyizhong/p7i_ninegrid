package com.zhenmei.p7i.ninegrid.round;
...
import com.zhenmei.p7i.ninegrid.ImageInfo;
import com.zhenmei.p7i.ninegrid.R;

import java.util.ArrayList;
import java.util.List;


public class RoundNineGridView extends ViewGroup {
    ...
    private RoundNineGridViewAdapter mAdapter;

    public RoundNineGridView(Context context) {
        this(context, null);
    }

    public RoundNineGridView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RoundNineGridView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//                gridWidth = gridHeight = (totalWidth - gridSpacing * (columnCount - 1)) / columnCount;
     ...
     * 设置适配器
     */
    public void setAdapter(@NonNull RoundNineGridViewAdapter adapter) {
        mAdapter = adapter;
        ...
        if (adapter.getImageInfo().size() > maxImageSize) {
            ...
            if (child instanceof RoundNineGridViewWrapper) {
                RoundNineGridViewWrapper imageView = (RoundNineGridViewWrapper) child;
    ...
    private void setRound() {
        ...
        if (imageViews.size() == 1) {
            imageViews.get(0).setCornerRadius(cornerRadius, cornerRadius, cornerRadius, cornerRadius);
        ...
        for (int i = 0; i < imageViews.size(); i++) {
            ...
            if (i == imageViews.size() - 1) {
                //最后一个都是两个圆角
                imageViews.get(i).setCornerRadius(0, cornerRadius, 0, cornerRadius);
                ...
                if (i % columnCount == 1) {
                    ...
                    //最左
                    imageViews.get(i).setCornerRadius(cornerRadius, 0, cornerRadius, 0);
...
//                imageView.setCornerRadius(cornerRadius, 0, 0, 0);
//            } else if (position % columnCount == 1) {
//                imageView.setCornerRadius(cornerRadius, 0, 0, 0);
//
//            } else if (position % columnCount == 2) {
//                imageView.setCornerRadius(cornerRadius, 0, 0, 0);
//
//            }
//
//
//        } else if (position <= columnCount * 2 && position > columnCount) {
//            //第2行
//
//        } else if (position <= columnCount * 3 && position > columnCount * 2) {
//            //第3行
//
//        }
    ...
    private ImageView getImageView(final int position) {
        ...
        if (position < imageViews.size()) {
            ...
            imageView = mAdapter.generateCircleImageView(getContext());
            imageView.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    mAdapter.onImageItemClick(getContext(), RoundNineGridView.this, position, mAdapter.getImageInfo());
                }
            });
